      ...
      >
        <div className="flex w-full flex-1 flex-col gap-10">
          <div className="space-y-6">
            ...
            <p className="contact-detail">
              ...
              <span className="contact-text">+61 484 305 049</span>
            </p>
            ...
            <p className="contact-detail">
              ...
              <span className="contact-text">bookings.machado@gmail.com</span>
            </p>
          </div>

          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-[0.3em] text-ink-muted">Follow me</h3>
        ...
        <div className="surface flex-1">
          <div className="mx-auto w-full max-w-xl">
            <h2 className="text-2xl font-semibold text-ink">What do you want to ask?</h2>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              {submitStatus === 'error' && (
                <p className="text-sm text-highlight">Failed to send message. Please try again.</p>
              )}
            </form>
          </div>
        </div>
      </motion.div>
      <div className="flex items-center justify-center pt-12 text-sm text-ink-muted lg:text-base">
